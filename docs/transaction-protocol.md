...
The receipt binds the baseline, patch hash, verification evidence and fingerprint, trajectory digest, access-log digest, and observed read/write sets. `mca tx receipt TRANSACTION_ID` renders non-source evidence for inspection.
